                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-start">
                            <h1 class="h4 text-gray-900 mb-4">Create a <strong>New</strong> Forum</h1>
                        </div>
                        <form method="post" action="{{ route('forum.create') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" name="title" class="form-control form-control-user" id="exampleFirstName"
                                           placeholder="Enter the forum title" value="{{ old('title') }}">
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea type="text" rows="4" name="description" class="form-control form-control-user"
                                           placeholder="Write a short forum description">{{ old('description') }}</textarea>
                            ...
                            <button type="submit" class="btn btn-primary btn-user">
                                <i class="fa fa-save"></i> Create Forum
                            </button>
